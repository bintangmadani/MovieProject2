...
public class WatchModel implements Parcelable {
    ...
    public Integer getPoster() { return poster; }

    public void setPoster(Integer poster) { this.poster = poster; }
    ...
    public static final Parcelable.Creator<WatchModel> CREATOR = new Parcelable.Creator<WatchModel>() {
        @Override
        public WatchModel createFromParcel(Parcel source) {return new WatchModel(source); }

        @Override
        public WatchModel[] newArray(int size) { return new WatchModel[size]; }
    };
}
